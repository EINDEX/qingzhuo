<template>
  <footer>
    <div
      class="bg-gray-300 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-4 items-centers justify-items-center"
    >
      <div class="grid h-24 grid-cols-4 gap-4 justify-items-center my-4">
